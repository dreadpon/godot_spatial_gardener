...
#	print("after duplicate_ifr ", curr_greenhouse.get_reference_count())
...
#		print("before perform_morph_actions ", curr_greenhouse.get_reference_count())
		PlantUtils.perform_morph_actions(curr_greenhouse, morph_actions)
#		print("after perform_morph_actions ", curr_greenhouse.get_reference_count())
		
#		print("before find_discrepancies ", curr_greenhouse.get_reference_count())
		if find_discrepancies(-1, curr_greenhouse, greenhouses[i], "during morphing '%d'->'%d'" % [i - 1, i]):
			morphs_gone_wrong += 1
#		print("after find_discrepancies ", curr_greenhouse.get_reference_count())
		
#		print("before execute_undo_redo_sequence ", curr_greenhouse.get_reference_count())
...
#		print("after execute_undo_redo_sequence ", curr_greenhouse.get_reference_count())
