...
static func snapshot_octree(root_octree_node:MMIOctreeNode) -> Dictionary:
	var snapshot := {}
...
static func snapshot_octree_node(octree_node:MMIOctreeNode):
	var snapshot := {}
